...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getOffersControllerService()
    {
        ...
        $this->services['App\\Controller\\OffersController'] = $instance = new \App\Controller\OffersController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'serializer' => '?',
            'session' => '?',
        ]))->withContext('App\\Controller\\OffersController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FEWWlwBDGo', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Rwtos3O5KU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\OffersMgr\\OfferRepository' => ['privates', 'App\\Repository\\OffersMgr\\OfferRepository', 'getOfferRepositoryService', false],
            'App\\Repository\\OffersMgr\\OffersRepository' => ['privates', 'App\\Repository\\OffersMgr\\OffersRepository', 'getOffersRepositoryService', false],
        ], [
            'App\\Repository\\OffersMgr\\OfferRepository' => '?',
            'App\\Repository\\OffersMgr\\OffersRepository' => '?',
        ])));
    ...
    /**
     * Gets the private 'App\Repository\OffersMgr\OfferRepository' shared autowired service.
     *
     * @return \App\Repository\OffersMgr\OfferRepository
     */
    protected function getOfferRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/OffersMgr/OfferRepository.php';

        return $this->privates['App\\Repository\\OffersMgr\\OfferRepository'] = new \App\Repository\OffersMgr\OfferRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\OffersMgr\OffersRepository' shared autowired service.
     *
     * @return \App\Repository\OffersMgr\OffersRepository
     */
    protected function getOffersRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OffersMgr/OffersRepository.php';

        return $this->privates['App\\Repository\\OffersMgr\\OffersRepository'] = new \App\Repository\OffersMgr\OffersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('s9uUj4YXZB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder2c4d9 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer3942d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertieseb521 = [
        
    ];

    public function getConnection()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getConnection', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getMetadataFactory', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getExpressionBuilder', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'beginTransaction', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getCache', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getCache();
    }

    public function transactional($func)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'transactional', array('func' => $func), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->transactional($func);
    }

    public function commit()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'commit', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->commit();
    }

    public function rollback()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'rollback', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getClassMetadata', array('className' => $className), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'createQuery', array('dql' => $dql), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'createNamedQuery', array('name' => $name), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'createQueryBuilder', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'flush', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'clear', array('entityName' => $entityName), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->clear($entityName);
    }

    public function close()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'close', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->close();
    }

    public function persist($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'persist', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'remove', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'refresh', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'detach', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'merge', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getRepository', array('entityName' => $entityName), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'contains', array('entity' => $entity), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getEventManager', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getConfiguration', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'isOpen', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getUnitOfWork', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getProxyFactory', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'initializeObject', array('obj' => $obj), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'getFilters', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'isFiltersStateClean', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'hasFilters', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return $this->valueHolder2c4d9->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer3942d = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder2c4d9) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder2c4d9 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder2c4d9->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__get', ['name' => $name], $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        if (isset(self::$publicPropertieseb521[$name])) {
            return $this->valueHolder2c4d9->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder2c4d9;
    ...
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;
    ...
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__isset', array('name' => $name), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;
    ...
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__unset', array('name' => $name), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;
    ...
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__clone', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        $this->valueHolder2c4d9 = clone $this->valueHolder2c4d9;
    }

    public function __sleep()
    {
        $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, '__sleep', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;

        return array('valueHolder2c4d9');
    }
    ...
    {
        $this->initializer3942d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer3942d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer3942d && ($this->initializer3942d->__invoke($valueHolder2c4d9, $this, 'initializeProxy', array(), $this->initializer3942d) || 1) && $this->valueHolder2c4d9 = $valueHolder2c4d9;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder2c4d9;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder2c4d9;
    }
}
