 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\OfferMgr\OffersHasCVsRepository")
 */
class Offers_has_CVs {
  ...
  /**
   * @ORM\ManyToOne(targetEntity="AppBundle\Entity\OfferMgr\Offers", inversedBy="offers_has_cvs",cascade={"persist"})
   * @ORM\JoinColumn(name="id_offer", referencedColumnName="id")
   */
  private $offer;

  /**
   * @ORM\ManyToOne(targetEntity="AppBundle\Entity\CvMgr\CV", inversedBy="offers_has_cvs",cascade={"persist"})
