 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\UserMgr\FormerStudentsRepository")
 */
class FormerStudents extends User {
  ...
  /**
   * @ORM\OneToMany(targetEntity="AppBundle\Entity\CvMgr\CV", mappedBy="formerstudent")
   */
  private $cvs;
