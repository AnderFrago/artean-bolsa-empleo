...
class CVEditorController extends Controller {
  ...
  public function stdntsWorkExpEditAction($id_std, Request $request) {
    ...
    $wrkexp_db = $em->getRepository('AppBundle:CvMgr\WorkExperiences')
      ->find($id_wrkexp);
  ...
  public function stdntsStudyEditAction($id_std, Request $request, Session $session) {
    ...
    // Get Study by Id
    $em = $this->getDoctrine()->getManager();
    $study_db = $em->getRepository('AppBundle:CvMgr\Studies')->find($id_study);
  ...
  public function stdntsLanguageEditAction($id_std, Request $request, Session $session) {
    ...
    // Get Study by Id
    $em = $this->getDoctrine()->getManager();
    $language_db = $em->getRepository('AppBundle:CvMgr\Languages')
  ...
  public function stdntsOtherknowledgeEditAction($id_std, Request $request, Session $session) {
    ...
    // Get Study by Id
    $em = $this->getDoctrine()->getManager();
    $otherknowlede_db = $em->getRepository('AppBundle:CvMgr\Otherknowledge')
      ->find($id_otherknowlede);
