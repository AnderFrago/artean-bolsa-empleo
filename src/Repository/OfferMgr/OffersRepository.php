...
class OffersRepository extends EntityRepository {
  ...
  public function findOffersByEmployeerUsername($username){
    $query = $this->getEntityManager()
      ->createQuery(
        'SELECT o FROM App:OfferMgr\Offers o
        JOIN o.employeer e
  ...
  public function findAllActive()
  {
    return $this->getEntityManager()
      ->createQuery(
        "SELECT o FROM App:OfferMgr\Offers o WHERE o.vOfferCode='ACTIVE' OR o.vOfferCode='PRUEBA'  ORDER BY o.modificationDate ASC"
      )
      ->getResult();
  }
  ...
  public function findOffersFromEmployeer($loggedin_username)
  {
    $query = $this->getEntityManager()
      ->createQuery(
        'SELECT o, e FROM App:OfferMgr\Offers o
        JOIN o.employeer e
        WHERE e.username = :username'
  ...
  public function findOwnerById($id)
  {
    return $this->getEntityManager()
      ->createQuery(
        'SELECT e.username FROM App:OfferMgr\Offers o
        JOIN o.employeer e 
        WHERE o.id = :id'
      )->setParameter('id', $id)
    ->getResult();
