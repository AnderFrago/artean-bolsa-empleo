...
/**
 * @ORM\Table(name="cv")
 * @ORM\Entity(repositoryClass="App\Repository\CvMgr\CVsRepository")
 */
class CV {
  ...
  /**
   * Methods to add elements to the arrays
   */
  ...
  /**
   * @ORM\ManyToOne(targetEntity="App\Entity\UserMgr\FormerStudents", inversedBy="cvs", cascade={"persist"})
  ...
  /**
   * @ORM\OneToMany(targetEntity="App\Entity\OfferMgr\Offers_has_CVs", mappedBy="cv")
   */
