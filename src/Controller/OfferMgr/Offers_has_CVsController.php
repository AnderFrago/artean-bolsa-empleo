...
use App\Entity\OfferMgr\Offers_has_CVs;
 ...
 */
class Offers_has_CVsController extends AbstractController {
   ...
   *
   * @Route("/show-cvs/{offerid}/{username}", name="candidate_cv_show", methods={"GET"} )
   */
